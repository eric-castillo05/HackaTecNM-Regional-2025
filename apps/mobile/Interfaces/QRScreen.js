...
const QRScreen = () => {
    ...
    const simulateAppOpen = () => {
        ...
        setTimeout(() => {
            ...
            alert('La aplicación StepVoice se ha abierto ');
        }, 3000); // 3 segundos de simulación
    };

    return (
        <View style={styles.container}>
            <Text style={styles.title}>Abrir Aplicación StepVoice</Text>

            {isOpening ? (
                <View style={styles.loadingContainer}>
                    <ActivityIndicator size="large" color="#005B96" />
                    <Text style={styles.loadingText}>Abriendo StepVoice...</Text>
                </View>
            ) : (
                <TouchableOpacity
                    style={styles.button}
                    ...
                    activeOpacity={0.7}
                >
                    <Text style={styles.buttonText}>Abrir StepVoice</Text>
                </TouchableOpacity>
            )}
        </View>
    );

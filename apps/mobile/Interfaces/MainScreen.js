    ...
    return (
        <View style={styles.container}>
            ...
            <Animated.View style={[styles.sidebar, { transform: [{ translateX: slideAnim }] }]}>
                ...
                {/* 🤖 STEPVOICE AI SECTION */}
                <MenuItem
                    icon="robot"
                    title="🤖 STEPVOICE AI Assistant"
                    type="FontAwesome5"
                    onPress={() => navigation.navigate("StepVoiceAI")}
                    color="#4A90E2"
                />
                <MenuItem
                    icon="cube"
                    ...
                    type="FontAwesome5"
                    onPress={() => navigation.navigate("AI3DExplorer")}
                    color="#4ECDC4"
                />
            ...
            <View style={styles.body}>
                <View style={styles.cardContainer}>
                    ...
                    >
                        ...
                        <FontAwesome5 name="robot" size={32} color="#4A90E2" />
                        <Text style={[styles.cardTitle, { color: '#4A90E2' }]}>🤖 STEPVOICE AI</Text>
                        <Text style={styles.cardSubtitle}>IA Conversacional con Voz</Text>
                    </TouchableOpacity>
                    ...
                    >
                        <View style={styles.featuredBadge}>
                            <Text style={styles.featuredBadgeText}>IA + 3D</Text>
                        </View>
                        <FontAwesome5 name="cube" size={32} color="#4ECDC4" />
                        <Text style={[styles.cardTitle, { color: '#4ECDC4' }]}>🎯 AI 3D Explorer</Text>
                        <Text style={styles.cardSubtitle}>Control de Modelos por Voz</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.card} onPress={() => navigation.navigate("PlotlyExplorer")}>
                        <FontAwesome5 name="chart-line" size={32} color="#4A90E2" />
